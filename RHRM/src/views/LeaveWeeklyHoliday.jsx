        ...
        <>
            ...
            >
                ...
                >
                    ...
                    <div className="bg-[white] relative  shadow-[0px_9px_26px_0px_#00000024]">
                        <div className="sticky mt-[40px] h-[auto]  p-2 z-10 flex items-start justify-between bg-[white] rounded-[12px]">
                            {/* "h-[300px] bg-[white] w-[1400px]" */}
                            <div
                                className={`${
                                    nabVarOpen
                                        ? "h-[300px] bg-[white] w-[1400px] pr-[10px] pl-[10px]"
                                        : "h-[300px] bg-[white] w-[1500px] pr-[10px] pl-[10px]"
                                }`}
                            >
                                <div className="">
                                    <div className="">
                                    ...
                                    <div className="">
                                        <div class="border-b border-gray-400 mt-[10px]"></div>
                                    </div>
                                    <div class="flex items-center justify-between mt-[20px]">
                                        <div class="flex items-center space-x-2">
                                            <label class="text-gray-700 text-sm flex items-center gap-2">
                                                Show
                                                <select class="border border-gray-300 rounded-md text-sm px-2 py-1 focus:outline-none focus:ring-2 focus:ring-blue-500 w-[60px] h-[30px] appearance-none">
                                        ...
                                        <div>
                                            <div class="flex items-center space-x-2">
                                                <label class="text-gray-700 text-sm">
                                                    ...
                                                    <input
                                                        type="search"
                                                        class="border-[1px] border-gray-300 rounded-md text-sm px-2 py-1 focus:outline-none focus:border-green-500 focus:ring-2 focus:ring-green-200 ml-[10px] w-[230px] h-[35px]"
                                                        placeholder=""
                                                    />
                                                </label>
                                            </div>
                                    ...
                                    <div class="mt-[20px]">
                                        <table class="w-full border border-gray-300">
                                            ...
                                            <tbody class="text-left">
                                                <tr class="bg-gray-200 group hover:bg-gray-300">
                                                    <td class="border border-gray-300 px-4 py-2 group-hover:bg-gray-400">
                                                        1
                                                    </td>
                                                    ...
                                                    <td class="border border-gray-300 px-4 py-2 ">
                                                        <a
                                                            href="#"
                                                            class="bg-blue-100 text-blue-600 hover:bg-blue-200 rounded-md px-2 py-1 text-sm inline-flex items-center w-[30px] h-[30px]"
                                                        >
                                                            <FontAwesomeIcon
                                                                icon={faEdit}
                                                            />
...
export default LeaveWeeklyHoliday;
