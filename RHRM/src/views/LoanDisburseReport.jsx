...
const LoanDisburseReport = () => {
    ...
    const links = [
        { id: 1, name: "Loan", url: "/loan/list" },
        {
            id: 2,
            name: "Loan disburse report",
            url: "/loans-report-loan_disburse_report",
        },
        { id: 3, name: "Employee wise loan", url: "/loans-report/employee" },
    ];
...
export default LoanDisburseReport;
