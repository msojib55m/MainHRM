...
import EmployeeParformanceOne from "../lib/EmployeeParformanceOne";
// try navbar toggle
// try navbar toggle
// show navbar
...
const EmployeeParformance = () => {
    ...
    useEffect(() => {
        FilteredData().forEach((data, index) => {
            data.links.forEach((link) => {
                if (locationn.pathname === link.path) {
                    setOpenIndex(index);
                }
            });
        });
    }, [locationn.pathname, searchInput]);
    ...
    return (
        <>
            <Helmet>
                <meta charSet="utf-8" />
                <title>Employ parformance </title>
                ...
                >
                    <div className="sticky mt-[100px] h-[80px] p-2 z-10 flex items-start justify-between bg-[white] rounded-[12px]">
                        <div className="w-full">
                            <div className="flex items-center justify-between w-full h-[50px] pr-[10px] pl-[10px] relative mt-[10px]">
...
export default EmployeeParformance;
