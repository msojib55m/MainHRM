...
import ManageEmployeeSalaryOne from "../lib/All_Salary/ManageEmployeeSalaryOne";
...
const ManageEmployeeSalary = () => {
    ...
    // link active now
    const links = [
        { id: 1, name: "Salary Advance ", url: "/payroll/salary-advance" },
        {
            id: 2,
